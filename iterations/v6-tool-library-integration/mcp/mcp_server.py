...
mcp = FastMCP("meta_agent", log_level="ERROR")
...
async def create_thread() -> str:
    """Create a new conversation thread for Meta_agent.
    Always call this tool before invoking Meta_agent for the first time in a conversation.
...
async def run_agent(thread_id: str, user_input: str) -> str:
    """Run the Meta_agent agent with user input.
    ...
    After you receive the code from Meta_agent, always implement it into the codebase unless asked not to.
